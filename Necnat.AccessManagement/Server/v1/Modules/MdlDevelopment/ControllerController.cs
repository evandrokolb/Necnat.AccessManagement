...
using Controller = Necnat.Shared.Entities.Controller;
...
namespace Necnat.AccessManagement.Server.v1.Modules.MdlDevelopment
{
    [ApiController]
    [ApiVersion("1.0")]
    public class ControllerController : NnControllerBase
    {
        ControllerService _service;
        ...
        public async Task<IActionResult> AInsert([FromQuery] string culture, [FromBody] Controller e)
        {
        ...
        public async Task<IActionResult> AUpdate([FromQuery] string culture, [FromBody] Controller e)
        {
        ...
        public async Task<IActionResult> AFilter([FromQuery] string culture, [FromQuery] string moduleCodeName, [FromQuery] string featureCodeName, [FromBody] MdControllerFilter md)
        {
        ...
        public async Task<IActionResult> AFilterSupport([FromQuery] string culture, [FromQuery] string moduleCodeName, [FromQuery] string featureCodeName, [FromBody] MdControllerFilter md)
        {
            var lFeature = new List<MdAuthorizedModuleFeature>
            {
                //ModuleDevelopment
